...
public class VannyRenderer extends GeoEntityRenderer<VannyEntity> {

    public VannyRenderer(EntityRendererManager renderManager)
    {
        super(renderManager, new VannyModel());
        this.shadowSize = 0.2F;
    }

    @Override
    public void render(VannyEntity entity, float entityYaw, float partialTicks, MatrixStack stack, IRenderTypeBuffer bufferIn, int packedLightIn) {
//        stack.push();
...
//        stack.pop();
    ...
    @Override
    public ResourceLocation getEntityTexture(VannyEntity entity) {
        return null;
    }
}
