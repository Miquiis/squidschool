...
import me.miquiis.school.common.entity.model.RoxanneModel;
...
public class RoxanneRenderer extends GeoEntityRenderer<RoxanneEntity> {

    public RoxanneRenderer(EntityRendererManager renderManager)
    {
        super(renderManager, new RoxanneModel());
        this.shadowSize = 0.2F;
    }

    @Override
    public void render(RoxanneEntity entity, float entityYaw, float partialTicks, MatrixStack stack, IRenderTypeBuffer bufferIn, int packedLightIn) {
//        stack.push();
...
//        stack.pop();
    ...
    @Override
    public ResourceLocation getEntityTexture(RoxanneEntity entity) {
        return null;
    }
}
